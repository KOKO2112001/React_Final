...
<nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top">
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     {userToken != null ?  <ul className="navbar-nav nav_center mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink className="nav-link "  aria-current="page" to="categories">Categoties</NavLink>
        </li>
      </ul> :""}

      <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ">
        {userToken !=null ? <><li className="nav-item d-flex align-items-center">
          
          <div className=' position-relative'>
            <Link to={"cart"}><i className='nav-link fa-solid text-main fa-cart-shopping py-2'></i></Link>
          <span className=' position-absolute top-0 end-0 translate-middle-y'>{item}</span>
          </div>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
          <NavLink className="nav-link cursor-pointer" to="login">Login</NavLink>
        </li>
        </> }
