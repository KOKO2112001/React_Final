...
let {isError,isLoading,isFetching,data ,refetch}= useQuery(['productApi',
page],getProductApi,{
   ...
   <CategoriesSlider></CategoriesSlider>
    <div className=' container-fluid mt-5'>
      <div className='row g-3'>
        {
          isLoading ? <div className=' loading d-flex justify-content-center align-items-center bg-black position-fixed top-0 end-0 start-0 bottom-0'>
             ...
             return <div key={element.id} className=' col-md-3'>
              ...
              <button onClick={()=>{AddTrueCart(element.id)}} className='btn bg-main text-white d-block w-100'>Add Product</button>
            </div>
            </div>
          })
          }
      ...
      <li className="page-item"><a className="page-link cursor-pointer" pageNumber='1' onClick={getPageNumber}>1</a></li>
      <li className="page-item"><a className="page-link cursor-pointer" pageNumber='2' onClick={getPageNumber}>2</a></li>
      <li className="page-item">
