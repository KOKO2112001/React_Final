...
export default function Login() {
  ...
  return (
   ...
   <div>
    ...
    {formStats ? <form onClick={form1.handleSubmit} >
       ...
       <div className='mb-3 my-5 py-5'>
         ...
         <input value={formik2.values.resetCode} onBlur={formik2.handleBlur} onChange={formik2.handleChange} className='form-control' type='resetCode' name='resetCode'id='resetCode' />
         {formik2.errors.resetCode && formik2.touched.resetCode ? <div className=' alert alert-danger'>{formik2.errors.resetCode}</div>:""}
        <br />
         <button className='btn bg-main text-white' type='submit'>Vriefy Code</button>
      </div>
       </form> }
   </div>
   </>
