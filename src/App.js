...
import { UserConext, UserConextProvider} from './Componet/userContext/userContext'
...
let routers = createHashRouter([
  {
    path:'/', element: <Layout />,children: [
      ...
      { path: 'categories', element:<GuradRouting><Categories/> </GuradRouting>},
      { path: 'brand', element:<GuradRouting><Brands/> </GuradRouting>},
      { path: 'checkout/:id', element:<GuradRouting><Checkout /> </GuradRouting>},
      { path: '/allorder', element:<GuradRouting><Allorder /> </GuradRouting>},
      { path: '/cart', element:<GuradRouting><Cart /> </GuradRouting> },
      { path: 'forgetbassord', element: <ForgetPassword />  },
      { path: '/ResetPassword', element: <ResetPassword />  },
      { path: 'product', element:<GuradRouting><Product /></GuradRouting>  },
      { path: 'wishList', element:<GuradRouting><WishList /></GuradRouting>  },
